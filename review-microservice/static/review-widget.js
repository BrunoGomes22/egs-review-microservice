async function loadReviews(productId, containerId) {
  const REVIEWS_API_URL = `https://grupo3-egs-deti.ua.pt/reviews/v1/entities/${productId}/reviews`;
  const AVERAGE_RATING_API_URL = `https://grupo3-egs-deti.ua.pt/reviews/v1/entities/${productId}/average-rating`;
  ...
  `;
    ...
    document.getElementById("review-form").addEventListener("submit", async (e) => {
      ...
      const res = await fetch("https://grupo3-egs-deti.ua.pt/reviews/v1/reviews", {
        method: "POST",
